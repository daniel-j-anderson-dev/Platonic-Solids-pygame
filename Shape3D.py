...
class Shape3D:
    ...
    def DrawPerspective(self, screen, camera, ORIGIN):
        ...
        for edge in self.edges:
            start_point = ((self.position[0] + projVerts[edge[0]][0] + ORIGIN[0]), (self.position[1] - projVerts[edge[0]][1] + ORIGIN[1]))
            end_point   = ((self.position[0] + projVerts[edge[1]][0] + ORIGIN[0]), (self.position[1] - projVerts[edge[1]][1] + ORIGIN[1]))
